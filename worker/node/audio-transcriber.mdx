...
<Note>
Also known as **Audio transcriber** (this page's original title, matching the Worker module `audio-transcriber`) or **Audio Reader Node** (technical name); `type: audioReaderNode`.
</Note>
